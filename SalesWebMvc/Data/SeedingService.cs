...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        //o metodo abaixo é pra popular a minha base de dados
        public void Seed()
        {
            //se tiver algum registro nas tabelas, eu nao vou proseguir com a operaçao:
            if (_context.Department.Any() ||
                  _context.Seller.Any() ||
                  _context.SalesRecord.Any())
            {
                return; //DB has been seeded. interrompe pq o banco de dados ja foi populado.
            }
            ...
            //esse context é atributo dessa classe, do tipo SalesWebMvcContext. Por isso ele acessa tudo da SalesWebMvcContext.cs.. incluindo essa tabela Department.
            ...
            //formula savechanges pra salvar as alteraçoes no banco de dados.
